...
services:
  new-api-master:
    ...
    environment:
      ...
      # - FRONTEND_BASE_URL=https://<your-newapi-domain> # Ignored on master nodes; only slave nodes use this
    volumes:
      - ./data:/data
      - ./logs:/app/logs
```
...
services:
  new-api-slave:
    ...
    environment:
      ...
      - TZ=Asia/Shanghai
      # Optional configuration
      # - FRONTEND_BASE_URL=https://<your-newapi-domain> # Redirects unmatched routes to this address
    volumes:
      - ./data:/data
      - ./logs:/app/logs
```
